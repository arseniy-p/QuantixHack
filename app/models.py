# app/models.py
from sqlalchemy import Column, String, Integer, DateTime, Enum as SQLAlchemyEnum, ForeignKey
...
class Call(Base):
    ...
    recording_status = Column(SQLAlchemyEnum(RecordingStatus), default=RecordingStatus.PENDING)
